...
// Kết nối CSDL
$db_host = "172.30.35.70"; // Official
$db_user = "user_c4"; // Official
$db_pass = "puser_c4"; // Official
...
if(isset($_POST['update-myadmin'])) {
    if ($_FILES["file-update"]["error"] > 0) {
        ...
        $newfilename = 'loc_thuc_db_admin' . '.' . end($temp);
            ...
            <div id="content-db-box" class="db-box">
              <div id="action-database">
                ...
                <fieldset>
                    ...
                    <form action="" method="POST">
                      <span>Action: </span>
                      <button type="submit" name="exit-db-btn" style="margin-right: 5px">Exit Database</button>
                    </form>
                  </fieldset>
              </div>
